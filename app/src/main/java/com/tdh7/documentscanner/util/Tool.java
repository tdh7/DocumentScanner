...
public class Tool {
    ...
    public static int isPathExist(String dir_path) {
    ...
    /*
    public static void showToast(Context mContext,String text, int time)
    {
      final Toast toast;
      //toast =  Toasty.warning(mContext,text,time);
      toast = Toasty.custom(mContext,text, R.drawable.emoticon_excited,R.color.library_back_color,time,true,true);
